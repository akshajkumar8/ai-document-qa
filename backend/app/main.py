...
def build_prompt(question: str, retrieved_chunks):
    ...
    prompt = (
        ...
        "1) If the answer clearly exists in the context, answer directly.\n"
        "2) If the relevant clause is present but contains obviously blank or missing values (for example phrases like \"day of , ,\" or sequences of multiple commas/underscores where key values should be), reply with: \"The lease term section is present, but the specific dates appear blank or not filled in in the extracted text,\" and then briefly summarize what the clause DOES say.\n"
        "3) Only reply with exactly: \"I don't know based on the provided document.\" if the relevant clause or information is not present at all in the context.\n\n"
